            ...
            if t == "problem":
                ...
                while group:
                    if group[0] == "-":
                        ...
                        # Append instead of overwriting to support multiple objects of the same type.
                        if obj_type not in objects:
                            objects[obj_type] = []
                        objects[obj_type].extend(object_list)
                        object_list = []
                    else:
                ...
                while group:
                    if group[0] == "-":
                        group.pop(0)
                        fixture_type = group.pop(0)
                        # Append instead of overwriting to support multiple fixtures of the same type.
                        if fixture_type not in fixtures:
                            fixtures[fixture_type] = []
                        fixtures[fixture_type].extend(fixture_list)
                        fixture_list = []
                    else:
