...
export MEMORY_STATIC_ACTION_MODE=gate
...
export RUN_ROOT="${RUN_ROOT:-${ROOT}/logs/robomemarena_extra8_pi05_v1_sdense5_static_gate_batch8_env${ENV_WORKERS}_$(date -u +%Y%m%d_%H%M%S)}"
