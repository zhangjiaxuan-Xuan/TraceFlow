...
case "${SAMPLE_ID}" in
  sample0) HORIZON=4; CONFIRMATIONS=2; REINFORCEMENTS=3 ;;
  sample1) HORIZON=5; CONFIRMATIONS=2; REINFORCEMENTS=3 ;;
  sample2) HORIZON=7; CONFIRMATIONS=2; REINFORCEMENTS=3 ;;
  sample3) HORIZON=6; CONFIRMATIONS=2; REINFORCEMENTS=2 ;;
  sample4) HORIZON=6; CONFIRMATIONS=2; REINFORCEMENTS=4 ;;
  sample5) HORIZON=6; CONFIRMATIONS=3; REINFORCEMENTS=3 ;;
...
RUN_NAME="${SAMPLE_ID}_h${HORIZON}_c${CONFIRMATIONS}_s0.02_p0.10_r${REINFORCEMENTS}_seed${SEED}"
export RUN_ROOT="${RUN_ROOT:-${FULL26_ROOT}/eval/feedback_bayes_round2/${RUN_NAME}}"
