...
FIRST_ROUND_ROOT="${FIRST_ROUND_ROOT:-/path/to/storage/datasets/robotics/RoboMemArena/derived/transferring_memory_eval/failure_20260808_082546/fusion}" \
START_ROUND=2 END_ROUND=3 POSITIVE_TOP_K=8 NEGATIVE_TOP_K=8 \
  bash "${ROOT}/scripts/robomemarena/run_predimem_transferring_cl_branch.sh" failure
